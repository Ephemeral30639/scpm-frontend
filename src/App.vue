<template>
  ...
  <el-menu
    ...
    <el-submenu index="features">
      ...
      <el-menu-item index="/takencoursesjunction"><router-link style="text-decoration: none; color: inherit;" to='/takencoursesjunction'>Course and Credit Tracking</router-link></el-menu-item>
...
export default {
    ...
    methods: {
      ...
      adminChange(instruction){
        switch(instruction) {
          case 'adminToolShow On':
            this.adminToolShow = true
            break;
          case 'adminToolShow Off':
            this.adminToolShow = false
            break;
          default:
            // code block
        }
