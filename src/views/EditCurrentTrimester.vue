  ...
  export default defineComponent ({
    ...
    methods:{
        onChange(){
            ...
            axios.get('https://localhost:5000/getcurrenttrimester/changecurrenttrimester', {params:{current: this.trimester, new: this.value}})
            .then(response => {
        ...
        addSchedule(){
            ...
            axios.post('https://localhost:5000/edittrimester/addschedule', null, {params:{id: this.input, date: this.dayRadio, time: time, trimester: this.trimester}})
            .then(response => {
                if(response.data == 'Error'){
        ...
        deleteSchedule(){
            ...
            axios.post('https://localhost:5000/edittrimester/deleteschedule', null, {params:{trimester: this.trimester, courses: coursesToDelete}}, {withCredentials: true})
            .then(response => {
                if(response.data == 'Error'){
    ...
    mounted(){
        ...
        axios.get('https://localhost:5000/getcurrenttrimester/availabletrimesters')
        .then(response => {
            if(response.data == 'Error'){
