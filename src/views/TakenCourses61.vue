...
export default defineComponent({
    ...
    methods: {
      ...
      search(){
        var allCourses = this.EnglishCourses.concat(this.NatSciCourses).concat(this.HumanityCourses).concat(this.SocialSciCourses).concat(this.PECourses).concat(this.CoreCourses).concat(this.RequiredCourses).concat(this.ElectiveCourses).concat(this.FreeElectiveCourses)
