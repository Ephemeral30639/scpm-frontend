...
import axios from 'axios'
  export default {
    ...
    mounted(){
      axios.defaults.withCredentials = true
      axios.get('http://localhost:5000/playground/currenttrimester')
        .then(response => {
            this.trimester = 'T1_2021_2022'

            axios.get('http://localhost:5000/playground/timetable', {params:{trimester: this.trimester}})
            .then(response => {
